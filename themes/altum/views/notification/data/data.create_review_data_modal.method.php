    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= $this->language->notification->create_review_data_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="create_notification_data" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><?= $this->language->notification->create_review_data_modal->input->title ?></label>
                    ...
                    <div class="form-group">
                        <label><?= $this->language->notification->create_review_data_modal->input->description ?></label>
                        <input type="hidden" class="form-control" name="key[]" value="description" required="required" />
                        <input type="text" class="form-control" name="value[]" required="required" />
                    </div>

                    <div class="form-group">
                        <label><?= $this->language->notification->create_review_data_modal->input->image ?></label>
                        <input type="hidden" class="form-control" name="key[]" value="image" required="required" />
                        <input type="text" class="form-control" name="value[]" required="required" />
                    </div>

                    <div class="form-group">
                        <label><?= $this->language->notification->create_review_data_modal->input->stars ?></label>
                        ...
                        <small class="form-text text-muted"><?= $this->language->notification->create_review_data_modal->input->stars_help ?></small>
                    </div>
