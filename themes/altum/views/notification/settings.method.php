...
<div class="custom-control custom-switch mr-3 mb-3">
    ...
    <div>
        <small class="form-text text-muted"><?= $this->language->notification->settings->trigger_all_pages_help ?></small>
    </div>
</div>
...
<div class="form-group" id="display_trigger">
    ...
    <small class="form-text text-muted"><?= $this->language->notification->settings->display_trigger_help ?></small>
</div>
...
<div class="form-group">
    ...
    <small class="form-text text-muted"><?= $this->language->notification->settings->display_frequency_help ?></small>
</div>
...
<div class="custom-control custom-switch mr-3 mb-3">
    ...
    <div>
        <small class="form-text text-muted"><?= $this->language->notification->settings->display_mobile_help ?></small>
    </div>
</div>
...
<div class="custom-control custom-switch mr-3 mb-3">
    ...
    <div>
        <small class="form-text text-muted"><?= $this->language->notification->settings->display_desktop_help ?></small>
    </div>
</div>
...
<div class="mt-5 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    ...
    <div id="notification_preview" class="notification-preview-<?= strtolower($data->notification->type) ?>">
        <?= \Altum\Notification::get($this->settings, $data->notification->type, $data->notification, $this->user)->html ?>
    </div>
</div>
