...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <div><small class="form-text text-muted"><?= $this->language->notification->settings->show_agreement_help ?></small></div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->thank_you_url_help ?></small>
    </div>
...
<?php ob_start() ?>
    ...
    <div id="data_send" class="container-disabled">
        <div class="form-group">
            ...
            <small class="form-text text-muted"><?= $this->language->notification->settings->data_send_webhook_help ?></small>
        </div>
        ...
        <div class="form-group">
            ...
            <small class="form-text text-muted"><?= $this->language->notification->settings->data_send_email_help ?></small>
        </div>
    </div>
