...
<?php ob_start() ?>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->conversion_title_help ?></small>
    </div>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->conversion_active_help ?></small>
    </div>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->image_help ?></small>
        <small class="form-text text-muted"><?= $this->language->notification->settings->conversion_active_help ?></small>
    </div>
    ...
    <div class="form-group">
        <label for="settings_conversions_count"><?= $this->language->notification->settings->conversions_count ?></label>
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->conversions_count_help ?></small>
    </div>

    <div class="form-group">
        <label for="settings_in_between_delay"><?= $this->language->notification->settings->in_between_delay ?></label>
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->in_between_delay_help ?></small>
    </div>
...
<div class="form-group">
    ...
    <small class="form-text text-muted"><?= $this->language->notification->settings->data_trigger_webhook_help ?></small>
</div>
...
<div class="form-group">
    <div class="custom-control custom-switch">
        ...
        <div><small class="form-text text-muted"><?= $this->language->notification->settings->data_trigger_auto_help ?></small></div>
    </div>
</div>
