...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_reviews_count"><?= $this->language->notification->settings->reviews_count ?></label>
        ...
        <small class="form-text text-muted"><?= $this->language->notification->settings->reviews_count_help ?></small>
    </div>
