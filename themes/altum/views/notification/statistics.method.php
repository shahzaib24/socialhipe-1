            ...
            <table class="table table-custom">
                <thead>
                    <tr>
                        <th></th>
                        <th>
                            <?= $this->language->notification->statistics->pageviews ?>
                        </th>
                    </tr>
                </thead>
                <tbody>
...
<script>
    ...
    new Chart(impressions_chart, {
        ...
        data: {
            ...
            datasets: [{
                label: <?= json_encode($this->language->notification->statistics->impressions_chart) ?>,
    ...
    new Chart(hovers_chart, {
        ...
        data: {
            labels: <?= $data->logs_chart['labels'] ?>,
            datasets: [{
                label: <?= json_encode($this->language->notification->statistics->hovers_chart) ?>,
