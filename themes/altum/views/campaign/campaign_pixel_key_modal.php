    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= $this->language->campaign_pixel_key_modal->install->header ?></h5>
            ...
            <div class="modal-body">
                <div class="tab-content">
                    <p class="text-muted"><?= $this->language->campaign_pixel_key_modal->install->subheader ?></p>

                    <pre id="pixel_key_html" class="pre-custom rounded"></pre>

                    <div class="mt-4">
                        <button type="button" class="btn btn-block btn-primary" data-clipboard-target="#pixel_key_html" data-copied="<?= $this->language->campaign_pixel_key_modal->install->copied ?>"><?= $this->language->campaign_pixel_key_modal->install->copy ?></button>
                    </div>
                </div>
            </div>
