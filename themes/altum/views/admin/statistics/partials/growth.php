...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-server fa-xs text-muted"></i> <?= $this->language->admin_statistics->growth->campaigns->header ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-user-shield fa-xs text-muted"></i> <?= $this->language->admin_statistics->growth->notifications->header ?></h2>
...
<script>
    ...
    new Chart(campaigns_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode($this->language->admin_statistics->growth->campaigns->chart) ?>,
    ...
    new Chart(notifications_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode($this->language->admin_statistics->growth->notifications->chart) ?>,
