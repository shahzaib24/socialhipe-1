                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="socialproofo">
                            <div class="form-group">
                                <label><?= $this->language->admin_settings->socialproofo->branding ?></label>
                                <input type="text" name="socialproofo_branding" class="form-control form-control-lg" value="<?= $this->settings->socialproofo->branding ?>" />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->socialproofo->branding_help ?></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"><?= $this->language->admin_settings->socialproofo->analytics_is_enabled_help ?></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"><?= $this->language->admin_settings->socialproofo->pixel_cache_help ?></small>
                            </div>
                        </div>
