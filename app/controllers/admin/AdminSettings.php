...
class AdminSettings extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            /* SocialProofo Tab */
            $_POST['socialproofo_branding'] = trim($_POST['socialproofo_branding']);
                ...
                foreach($settings_keys as $key => $value) {
                    ...
                    if(is_array($value)) {
                        ...
                        foreach($value as $sub_key) {
                            ...
                            if(!in_array($key . '_' . $sub_key, ['socialproofo_branding', 'custom_head_css', 'custom_head_js', 'ads_header', 'ads_footer', 'offline_payment_instructions'])) {
