...
class Notification {
    ...
    public static function get($settings, $notification_type, $notification = null, $user = null, $force_branding = null) {
        ...
        if(!$notification) {
            ...
            $notification->settings = (object) self::$notifications_config[strtoupper($notification_type)];
        }
        ...
        $data = require THEME_PATH . 'views/partials/notifications/' . strtolower($notification_type) .'.php';
    ...
    public static function get_config($notification_type = false) {
        ...
        if(!$notification_type) {
            ...
            return self::$notifications_config[strtoupper($notification_type)] ?? false;
